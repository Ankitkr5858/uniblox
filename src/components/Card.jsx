...
const Card = ({ shoe }) => {
  ...
  return (
    <div>
      <div className=" h-[420px]  shadow-sm rounded-2xl p-4 bg-slate-50 dark:bg-[#1f] dark:text-Black dark:outline-none dark:border-none border border-slate-100 outline outline-slate-100  hover:shadow-2xl relative">
        <div className=" flex flex-col gap-6">
          ...
          <div className="flex  items-center justify-between">
            ...
            <span className="text-xl font-semibold">{price} Rs</span>
          </div>
        </div>
      </div>
    </div>
