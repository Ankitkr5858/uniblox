...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 p-1 md:p-4 flex items-center justify-between h-10 w-full">
      ...
      <ul className="hidden md:flex text-sm  text-black dark:text-Black font-semibold md:tracking-wide  flex-col  gap-2 md:flex-row  md:gap-8">
        <li>
          <Link to="/">Home</Link>
        </li>
        {/* <li>
